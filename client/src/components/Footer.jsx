export function Footer () {
  return (
    <footer className='flex justify-end items-end h-72 bg-[]'>
      <section className='relative w-full min-h-[100px] bg-[#7b98c9] flex justify-center items-center flex-col'>
        ...
        <p className='text-center text-white mt-1.5 max-w-3xl'>FacturIZI es tu aliado confiable en soluciones de facturación. Nos dedicamos a simplificar tus procesos contables, proporcionándote herramientas avanzadas y servicios personalizados para optimizar la gestión de tus facturas.</p>
