    ...
    <>
      ...
      <main className='flex'>
        <div
          ...
          className={`w-full h-screen fixed top-0 left-0 bg-slate-950 bg-opacity-50 ${responsiveSideMenu ? ' -translate-x-full ' : ' w-full '} lg:translate-x-0 lg:w-52 transition`}
        >
          <aside className='bg-gray-100 h-screen fixed top-0 left-0 pt-14 z-40 lg:translate-x-0 lg:w-52 transition flex flex-col justify-between'>
